...
class Model(tf.keras.Model):
    ...
    def __init__(self, no_rew_early_stop=10, rnn_size=256, latent_space=32, controller_size=128, output_size=3, hada=False, hidden=True, use_prev_act=False):
        super().__init__()
    ...
    def mutate(self):
        ...
        self.epsilon *= np.random.choice([1.06, 1.06, 0.94] + 97*[1])
